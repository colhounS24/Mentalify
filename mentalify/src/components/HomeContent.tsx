      ...
      <div className="carousel-inner">
        <div className="carousel-item active">
          ...
          <div className="carousel-caption d-none d-md-block fw-bold">
            <h1 className="display-5">Inter-Generational Bonding</h1>
            <p>
        ...
        <div className="carousel-item">
          ...
          />
          <div className="carousel-caption d-none d-md-block fw-bold">
            <h1 className="display-5">Improve Cognitive Ability</h1>
            <p>
        ...
        <div className="carousel-item">
          ...
          />
          <div className="carousel-caption d-none d-md-block fw-bold">
            <h1 className="display-5">Gain Knowledge</h1>
            <p>
              Mentalify provides an abundance of educational materials regarding
              Human Memory Education
            </p>
          </div>
        </div>
      </div>
